...
![WLED-Studio Logo](logo.jpeg)

*A user-friendly Python application to stream videos, images, and animations directly to your WLED-powered LED video wall.*

[![GitHub stars](https://img.shields.io/github/stars/BradyMeighan/WLED-Studio.svg?style=social&label=Star)](https://github.com/BradyMeighan/WLED-Studio)
...
- **Customization:**
  - 🎛️ Adjustable resolution, cropping, scaling, and interpolation
